...
/**
 * This currently checks if the current User is allowed to access a certain end
 * point using their role.
 */
...
public class SecurityCredentialsConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http
				...
				.mvcMatchers(HttpMethod.POST, "/auth").permitAll().mvcMatchers(HttpMethod.POST, "/project")
				...
				.antMatchers(HttpMethod.GET, "/actuator/health").permitAll().antMatchers(HttpMethod.GET, "/actuator/**")
				.permitAll().antMatchers(HttpMethod.GET, "/actuator/routes").permitAll()
