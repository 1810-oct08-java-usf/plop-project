...
public class S3StorageServiceImpl implements StorageService {
	...
	/**
	 * init draws on environment variables setting up an s3Client used to store
	 * objects Added @Transactional
	 */
	@Transactional
	@PostConstruct
	public void init() {
	...
	private String generateUrl(String object, int seconds) {
		...
		GeneratePresignedUrlRequest generatePresignedUrlRequest = 
				...
				object).withMethod(HttpMethod.GET).withExpiration(expiration.toDate());
