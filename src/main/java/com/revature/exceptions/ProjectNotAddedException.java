 ...
 * but missing key information such as the name, batch, repo links and tech stack. There is a custom
 * message for this exception to explain why the exception was thrown.
 */
