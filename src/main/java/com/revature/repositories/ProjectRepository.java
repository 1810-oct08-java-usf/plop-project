...
public interface ProjectRepository extends MongoRepository<Project, String> {
	...
	/**
	 * ProjectRepository.findByName accepts a project name and returns a list of projects with that name
	 * 
	...
	/**
	 * ProjectRepository.findByBatch accepts a project batch and returns a list of projects with that batch
	 * 
	...
	/**
	 * ProjectRepository.findByTrainer accepts a project trainer and returns a list of projects with that trainer
	 * 
	...
	/**
	 * ProjectRepository.findByStatus accepts a project status and returns a list of projects with that status
	 * 
