...
public class FileHelper {
	...
	/**
	 * overloaded version of FileHelper.convert that accepts a MultipartFile and returns a corresponding File
	 * 
...
//	}
	...
	/**
	 * overloaded version of FileHelper.convert that accepts a byteArray and returns a corresponding File
	...
	public static File convert(byte[] byteArray, String fileName) throws IOException {
		// TODO this appears to write the file to the server's filesystem--should
		// be avoided if possible since we only want to make the conversion in application memory
