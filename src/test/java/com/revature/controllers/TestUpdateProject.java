...
/**
 * Class containing MockMVC tests for the update project method in the project controller.
 *
...
public class TestUpdateProject {
  ...
  @MockBean private ProjectRepository mockProjectRepository;
  ...
  /**
   * This method will test updating a project through the controller. The controller will accept a
   * PUT request with an id to update the proper project. The project that will be updated will be
  ...
  public void testUpdateProjectWhenApproved() throws Exception {
     ...
     */
    this.mockMvc
        .perform(put(URI).contentType(MediaType.APPLICATION_JSON_VALUE).content(requestJson))
        .andExpect(status().isOk())
        .andExpect(content().string(expectedResult));
  }

  /**
   * This method will test that updating a denied project will not get a different result than an
   * approved one.
   *
   * @throws Exception
   * @author Jaitee Pitts (190107-Java-Spark-USF)
  ...
  /**
   * This method will test that updating a project with a pending status will not get a different
  ...
  /**
   * This method will test that updating a project with an invalid status will not be allowed.
   *
   * @throws Exception
   * @author Jaitee Pitts (190107-Java-Spark-USF)
   */
